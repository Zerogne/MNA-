...
const reviews = [
  {
    quote:
      "MNA Car-аар дамжуулан Toyota Land Cruiser авсан бөгөөд бүх үйл явц маш жигд явагдсан. Тэдний баг надад бүх шатанд мэдэгдэж байсан. Маш их зөвлөж байна!",
    name: "Батбаяр Д.",
    city: "Улаанбаатар",
  },
  {
  ...
  {
    quote:
      "Тэднээс авч буй гурав дахь машин минь. Үнэ нь үргэлж өрсөлдөхүйц бөгөөд чанар нь яг тайлбарласантай адил. Хуучин машины миний гол нийлүүлэгч.",
    name: "Гантулга М.",
    city: "Эрдэнэт",
  },
  {
