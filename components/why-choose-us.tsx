...
const reasons = [
  {
    icon: Car,
    title: "Дуудлага худалдаанаас шууд",
    description:
      "Бид бүх машинаа хамгийн том дуудлага худалдаанаас шууд олж авдаг — зуучгүй, нэмэлт төлбөргүй.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "Боомтоос далайн болон хуурай замын тээврээр шууд Улаанбаатар хүртэл. Ердийн хүргэлтийн хугацаа: 6–8 долоо хоног.",
  },
  {
    icon: MessageCircle,
